        ...
        <div className="space-y-4">
          <ContentCard>
            ...
            <p className="text-gray-100 leading-relaxed text-[15px]">
              The Platform is owned by NumeroMobile Private Limited, a company incorporated under
              the Companies Act, 1956. Your use of the Platform and services are governed by these
              Terms of Use.
            </p>
          </ContentCard>
          ...
          <PolicySection title="Log Files">
            Chalchitra follows a standard procedure of using log files. These files log visitors
          ...
          <PolicySection title="Cookies and Web Beacons">
            Like any other website, Chalchitra uses cookies. These cookies are used to store
          ...
          <PolicySection title="Children's Information">
            Chalchitra does not knowingly collect any Personal Identifiable Information from
