...
export default function ContactUs() {
 ...
 <ContactRow icon={<Building2 size={18} className="text-red-400" />} label="Company" value="Alphamovil Digital Solutions LLP" />
 <div className="border-t border-white/5" />
 <ContactRow icon={<MapPin size={18} className="text-red-400" />} label="Address" value="B-123, SUNCITY, SECTOR-54, Gurgaon, Haryana, 122011" />
 <div className="border-t border-white/5" />
 <ContactRow icon={<Phone size={18} className="text-red-400" />} label="Phone">
 <a href="tel:+919667687077" className="text-red-400 hover:text-rose-300 hover:underline">9667687077</a>
 </ContactRow>
 <div className="border-t border-white/5" />
 <ContactRow icon={<Mail size={18} className="text-red-400" />} label="Email">
 <a href="mailto:bd@alphamovil.com" className="text-red-400 hover:text-rose-300 hover:underline">bd@alphamovil.com</a>
 </ContactRow>
 <div className="border-t border-white/5" />
 ...
 Email us at{' '}
 <a href="mailto:bd@alphamovil.com" className="text-red-400 hover:text-rose-300 hover:underline">
 bd@alphamovil.com
 </a>{' '}
