...
import { LatestVideosSection } from '@/sections/LatestVideosSection';
  ...
  return (
    <div className="relative w-full overflow-x-hidden bg-[#07111f] text-white">
      ...
      <div className="relative z-10 pt-[100px] sm:pt-[108px] lg:pt-16">
        ...
        {/* New CDN videos — 6 themed slider rows */}
        ...
        <div id="rss-feeds" className="pt-6 sm:pt-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4">
            ...
            <p className="mt-2 max-w-xl text-xs sm:text-sm text-white/55">
              Your hardcoded catalog content appears first. These lower feed blocks are for global
              entertainment discovery around Hollywood, celebrity chatter, international fandom,
              Europe, Native voices and Latin pop culture.
            </p>
            <p className="mt-2 max-w-2xl text-[11px] sm:text-xs text-white/35 leading-relaxed">
              Demo presentation only. RSS and live feed references here are for entertainment
              discovery and non-commercial showcase use, not positioned as owned or commercial
              editorial streams.
            </p>
          </div>
