...
export function StaffPicksSection() {
 ...
 <div>
 <h2 className="text-3xl md:text-5xl font-bebas font-black text-slate-900">❤️ Staff Picks</h2>
 <p className="text-slate-500 text-xs sm:text-sm mt-1">Titles our team personally loves</p>
