...
const cards = [
 { id: '1', title: 'Grilled Salmon', category: 'Seafood', duration: '25 min', students: '87K', rating: '9.8', img: '/landscape_new_desicontent/4.png' },
 { id: '2', title: 'Mushroom Risotto', category: 'Italian', duration: '40 min', students: '72K', rating: '9.6', img: '/landscape_new_desicontent/5.png' },
 { id: '3', title: 'Chicken Tikka', category: 'Indian', duration: '45 min', students: '134K', rating: '9.9', img: '/landscape_new_desicontent/6.png' },
 { id: '4', title: 'Beef Tacos', category: 'Mexican', duration: '30 min', students: '96K', rating: '9.7', img: '/landscape_new_desicontent/7.png' },
 { id: '5', title: 'Shakshuka', category: 'Breakfast', duration: '20 min', students: '118K', rating: '9.8', img: '/landscape_new_desicontent/8.png' },
 { id: '6', title: 'Lobster Bisque', category: 'Seafood', duration: '55 min', students: '54K', rating: '9.5', img: '/landscape_new_desicontent/9.png' },
 { id: '7', title: 'Pad Thai', category: 'Thai', duration: '25 min', students: '109K', rating: '9.7', img: '/landscape_new_desicontent/10.png' },
 ...
 { id: '9', title: 'Avocado Toast', category: 'Healthy', duration: '15 min', students: '201K', rating: '9.6', img: '/landscape_new_desicontent/12.png' },
 ...
 { id: '11', title: 'Pho Bo Soup', category: 'Vietnamese', duration: '60 min', students: '78K', rating: '9.7', img: '/landscape_new_desicontent/14.png' },
 { id: '12', title: 'Baklava', category: 'Dessert', duration: '50 min', students: '45K', rating: '9.5', img: '/landscape_new_desicontent/15.png' },
 { id: '13', title: 'Eggs Benedict', category: 'Breakfast', duration: '20 min', students: '92K', rating: '9.6', img: '/landscape_new_desicontent/3.png' },
 { id: '14', title: 'Lamb Kofta', category: 'Middle East', duration: '35 min', students: '67K', rating: '9.5', img: '/landscape_new_desicontent/4.png' },
 { id: '15', title: 'Tonkotsu Ramen', category: 'Japanese', duration: '120 min',students: '83K', rating: '9.9', img: '/landscape_new_desicontent/5.png' },
 { id: '16', title: 'Bibimbap Bowl', category: 'Korean', duration: '35 min', students: '76K', rating: '9.7', img: '/landscape_new_desicontent/6.png' },
 { id: '17', title: 'Focaccia Bread', category: 'Baking', duration: '180 min',students: '58K', rating: '9.6', img: '/landscape_new_desicontent/7.png' },
 { id: '18', title: 'Tiramisu', category: 'Dessert', duration: '45 min', students: '112K', rating: '9.8', img: '/landscape_new_desicontent/8.png' },
 { id: '19', title: 'Mango Sticky Rice', category: 'Thai', duration: '30 min', students: '89K', rating: '9.7', img: '/landscape_new_desicontent/9.png' },
 { id: '20', title: 'Cinnamon Rolls', category: 'Baking', duration: '150 min',students: '127K', rating: '9.8', img: '/landscape_new_desicontent/10.png' },
];
