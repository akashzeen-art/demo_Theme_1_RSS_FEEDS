...
const cards = [
 ...
 { id: '3', title: 'Chicken Tikka', category: 'Indian', duration: '45 min', students: '134K', rating: '9.9', img: '/Landscape-New-Desi/BLACK SIGNAL.jpg' },
 { id: '4', title: 'Beef Tacos', category: 'Mexican', duration: '30 min', students: '96K', rating: '9.7', img: '/Landscape-New-Desi/DANGEROUS ALLIANCE.jpg' },
 { id: '5', title: 'Shakshuka', category: 'Breakfast', duration: '20 min', students: '118K', rating: '9.8', img: '/Landscape-New-Desi/DANGEROUS MINDS EP1.jpg' },
 ...
 { id: '7', title: 'Pad Thai', category: 'Thai', duration: '25 min', students: '109K', rating: '9.7', img: '/Landscape-New-Desi/DANGEROUS MINDS EP3.jpg' },
 ...
 { id: '9', title: 'Avocado Toast', category: 'Healthy', duration: '15 min', students: '201K', rating: '9.6', img: '/Landscape-New-Desi/DANGEROUS TERRITORY.jpg' },
 ...
 { id: '11', title: 'Pho Bo Soup', category: 'Vietnamese', duration: '60 min', students: '78K', rating: '9.7', img: '/Landscape-New-Desi/DEAD END MISSON.jpg' },
 { id: '12', title: 'Baklava', category: 'Dessert', duration: '50 min', students: '45K', rating: '9.5', img: '/Landscape-New-Desi/ESCAPE BEYOND FEAR EP1.jpg' },
 { id: '13', title: 'Eggs Benedict', category: 'Breakfast', duration: '20 min', students: '92K', rating: '9.6', img: '/Landscape-New-Desi/BEYOND SUSPICION EP2.jpg' },
 { id: '14', title: 'Lamb Kofta', category: 'Middle East', duration: '35 min', students: '67K', rating: '9.5', img: '/Landscape-New-Desi/BLACK DIARY SECRETS  EP1.jpg' },
 { id: '15', title: 'Tonkotsu Ramen', category: 'Japanese', duration: '120 min',students: '83K', rating: '9.9', img: '/Landscape-New-Desi/BLACK DIARY SECRETS  EP2.jpg' },
 { id: '16', title: 'Bibimbap Bowl', category: 'Korean', duration: '35 min', students: '76K', rating: '9.7', img: '/Landscape-New-Desi/BLACK SIGNAL.jpg' },
 { id: '17', title: 'Focaccia Bread', category: 'Baking', duration: '180 min',students: '58K', rating: '9.6', img: '/Landscape-New-Desi/DANGEROUS ALLIANCE.jpg' },
 { id: '18', title: 'Tiramisu', category: 'Dessert', duration: '45 min', students: '112K', rating: '9.8', img: '/Landscape-New-Desi/DANGEROUS MINDS EP1.jpg' },
 { id: '19', title: 'Mango Sticky Rice', category: 'Thai', duration: '30 min', students: '89K', rating: '9.7', img: '/Landscape-New-Desi/DANGEROUS MINDS EP2.jpg' },
 { id: '20', title: 'Cinnamon Rolls', category: 'Baking', duration: '150 min',students: '127K', rating: '9.8', img: '/Landscape-New-Desi/DANGEROUS MINDS EP3.jpg' },
];
...
export function CookingTenGridSection() {
 ...
 className={`absolute top-1.5 right-1.5 p-1 rounded-full border transition-all ${liked.has(card.id) ? 'bg-red-500/30 border-red-500/60' : '/50 border-white/20'}`}
 >
