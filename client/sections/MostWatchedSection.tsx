...
export function MostWatchedSection() {
 ...
 <div>
 <h2 className="text-3xl md:text-5xl font-bebas font-black text-slate-900">👁️ Most Watched</h2>
 <p className="text-slate-500 text-xs sm:text-sm mt-1">Titles our community can't stop watching</p>
