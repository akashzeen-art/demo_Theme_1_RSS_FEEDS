...
export function CriticsChoiceSection() {
 ...
 <div>
 <h2 className="text-3xl md:text-5xl font-bebas font-black text-slate-900">⭐ Critics' Choice</h2>
 <p className="text-slate-500 text-xs sm:text-sm mt-1">Top-rated titles by our expert critics</p>
