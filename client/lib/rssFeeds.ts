...
> = {
  reels: {
    title: 'Reels',
    subtitle: 'Bite-sized entertainment',
    path: '/reels',
  ...
  live: {
    title: 'Live',
    subtitle: 'Entertainment live & sessions',
    path: '/live',
  ...
  sports: {
    title: 'Sports',
    subtitle: 'Sports entertainment & highlights',
    path: '/sports',
  ...
  movies: {
    title: 'Movies',
    subtitle: 'Clips, trailers & cinema',
    path: '/movies',
  ...
  webseries: {
    title: 'Web Series',
    subtitle: 'Shows, trailers & binge picks',
    path: '/webseries',
